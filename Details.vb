  ...
  Namespace IO
    Public Class PropertyAccessor
      ...
      Public Shared Function GetProp(fileName As String) As IDictionary(Of String, String)
        Dim pp As IDictionary(Of String, ArrayList) = GetPropWithDuplicatedKeys(fileName)
      ...
      Public Shared Function GetPropWithDuplicatedKeys(fileName As String) As IDictionary(Of String, ArrayList)
      ...
      Public Shared Sub AppendOnlyPropThatDoesNotExists(fileName As String, p As IDictionary(Of String, String))
        Dim keys As ICollection(Of String) = GetPropWithDuplicatedKeys(fileName).Keys
